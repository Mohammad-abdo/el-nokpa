        ...
        <div className="delivery position-relative rounded-16 bg-main-600 p-16 flex-align gap-16 flex-wrap z-1">
          ...
          <div className="row align-items-center">
            <div className="col-md-3 d-md-block d-none">
              <div className="delivery__man text-center bg-white p-4 shdow rounded">
                <img src="assets/images/logo/1logo.png" alt="" />
              </div>
            </div>
            ...
            <div className="col-md-4 col-sm-5 d-sm-block d-none bg-white rounded p-4">
